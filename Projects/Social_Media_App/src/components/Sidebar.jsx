                    ...
                    <ul className="space-y-2 font-medium">
                        <li onClick={() => { setSelectedTab("Home") }}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <User width={30} height={30} stroke="#A855F7" strokeWidth={1.5} />

                                <span ><GradientText
                                    colors={["#3B82F6", "#A855F7", "#40ffaa", "#EC4899", "#40ffaa"]}
                                    animationSpeed={8}
                                    showBorder={false}
                        ...
                        <li onClick={() => { setSelectedTab("Home") }}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className={`ms-3 ${selectedTab === "Home" && "text-gray-500"}`}>Home</span>
                            </a>
                        </li>
                        <li onClick={() => { setSelectedTab("Create Post") }}>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className={`flex-1 ms-3 whitespace-nowrap ${selectedTab === "Create Post" && "text-gray-500"}`} >Create Post</span>
